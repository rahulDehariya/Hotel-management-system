            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 push-lg-4">
                        ...
                        <h4 class="text-muted mb-0">Register new profile or already have account <a href="login.php" class="btn btn-outline-secondary"><span>Login</span></a> </h4>
          ...
          <div class="container">
             <div class="row">
              <div class="col-md-3 col-sm-2"></div>
                ...
                <div id="register_content" class="col-md-6 col-sm-8">
