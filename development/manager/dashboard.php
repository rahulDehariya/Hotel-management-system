...
// $membership_discount = array('Gold'=>15,'silver'=>10,'Bronze'=>5);
 // print_r($_SESSION);
          ...
          <div class="col-md-12">
            <div class="card ">
             ...
             <?php $p = 0; 
                ...
                <div class="card-header " id="department_buttons_<?php echo $department['id']; ?>">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <button type="button" class="btn btn-default table_switch_btn" id="full_btn" onclick="show_table('full')">ORDERED</button>
              <button type="button" class="btn btn-default table_switch_btn" id="full_btn" onclick="show_table('payment')">Payment</button>
            ...
            <div class="add_new_item_div" style="padding: 15px;border: 1px solid #ddd;margin: 0 0 10px 0px;">
              ...
              <div class="row">
                ...
                <div class="row">
                  ...
                  <input type="hidden" name="membership_discount" id="membership_discount" value="0">
             ...
             <form action="javascript:void(0);" method="post" class="cart" id="order_payment" style="width:100%">
              <div class="col-md-8">
                  <br> 
                   ...
                   <input  name="total_discounted_item_price"  id="total_discounted_price"  type="hidden" value="0" />
                   <input  name="total_discount_price"  id="total_discount_price"  type="hidden" value="0" />
                ...
                <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-12">
                       <table style="border: 1px solid #ddd;width: 100%;margin-top: 20px;" id="cart_list_items" class="form-group">
                        <thead class="cart__row cart__header">
                            <tr>
                                <th class="cart_items">SNo</th>
                                <th class="cart_items">Item Code</th>
                                <th class="cart_items">Name</th>
                                <th class="cart_items">Price</th>
                                <th class="cart_items">Discount</th>
                                <th class="cart_items">Action</th>
                            </tr>
                            </thead>
...
// });
  ...
  <script>
    ...
    var membership_discount={1:15,2:10,3:5};
    ...
    function update_client_onInvoice(){
    	...
    	$.ajax({
            ...
            success: function (response) {
              ...
              jobType=Number(response);
           
            // alert(jobType);
            $("#job_type").val(jobType);

              var membership_type= membership_discount[jobType];
               $("#membership_discount").val(membership_type);
    ...
    function CreateNewTable()
    {
    	...
    	$.ajax({
            ...
            success: function (response) {
            	...
            	$("#department_buttons_"+department_id).append(new_button);
            }
        });
    }
    ...
    function finalammount()
    {
      ...
      var total_price_discounted=$("#total_discounted_price").val();

      var totalP=Number(total_payment)+Number(gst1)+Number(gst2)-Number(discount)-Number(total_price_discounted);

      // alert(total_price_discounted);
      // alert(totalP);
            ...
            success: function (response)
              {
              	...
              	var selectItem_list="<option></option><option value='0'>Not an member</option>";
              	for(var i=0;i<obj.length;i++)
              	{
    	...
    	$.ajax({
            ...
            success: function (response) {
              ...
              // $("#myModal").load();
                ...
                var jobtype=Number(data['jobType']);
                $("#job_type").val(jobtype);
              ...
              var discountType=data['discountType'];
            	...
            	for(var p=0; p<items.length; p++){
            		k=p+1;
            		//alert(items[p]['sgst']);
                 var info1='<td class="cart_items">'+items[p]['info1']+'</td>';
                  if(discountType==1 && membership_type>0)
                  {
                    info1='<td class="cart_items">'+items[p]['info1']+'<span class="applied_discount">*</span></h4></td>';
                  }

            		total_price=total_price+items[p]['subtotal'];
            		item_list+='<tr id="item_'+items[p]['id']+'"><td class="cart_items"><input type="hidden" id="itemCode_'+items[p]['id']+'" value="'+items[p]['itemCode']+'"><input type="hidden" id="itemQTY_'+items[p]['id']+'" value="'+items[p]['quantity']+'">'+k+'</td><td class="cart_items">'+items[p]['itemCode']+'</td>'+info1+'<td class="cart_items">'+items[p]['quantity']+'</td><td class="cart_items">'+items[p]['unit_price']+'</td><td class="cart_items">'+items[p]['subtotal']+'</td><td class="cart_items"><a href="javascript:void(0)" onclick="edit_itemInvoice('+items[p]['id']+')">Edit</a> <a href="javascript:void(0)" onclick="deleteItemInvoice('+items[p]['id']+')">Delete</a></td></tr>';
            	}
            	// alert(total_price);
                ...
                if(discountType==1 && membership_type>0)
                  {
                    ...
                    var price_item = items[p]['subtotal'];

                    var discount = $("#membership_discount").val();

                    discount_applied = price_item*discount/100;

                    total_item_price1=Number(total_item_price)+Number(price_item);
                    total_discount_price1=Number(total_discount_price)+Number(discount_applied);

                    total_item_price=total_item_price1.toFixed(2);
                    total_discount_price=total_discount_price1.toFixed(2);
                    // alert(discount_applied[]);
                   payment_table_data+='<tr id="item_discount_'+items[p]['id']+'"><td class="cart_items"><input type="hidden" id="itemCode_'+items[p]['id']+'" value="'+items[p]['itemCode']+'"><input type="hidden" id="itemQTY_'+items[p]['id']+'" value="'+items[p]['quantity']+'"><input type="hidden" class="discount" value="'+discount_applied+'">'+k+'</td><td class="cart_items">'+items[p]['itemCode']+'</td><td class="cart_items">'+items[p]['info1']+'</td><td class="cart_items">'+items[p]['subtotal']+'</td><td class="cart_items">'+discount_applied+'</td><td class="cart_items"><a href="javascript:void(0)" onclick="removeDiscount_item('+items[p]['id']+','+discount_applied+')">x</a></td></tr>';
              ...
              {
                payment_table_data = '<tr><td colspan="6"> No data found</td></tr>';
              }


              payment_table_data+='<tr id="item_total"><td class="cart_items"><input type="hidden" id="total_discounted_item_price" value="0">Total</td><td class="cart_items"></td><td class="cart_items"></td><td  class="cart_items">'+total_item_price+'</td><td class="cart_items" id="Discount_total">'+total_discount_price+'</td>';
              if(total_discount_price>0){

             payment_table_data+= '<td class="cart_items"><a href="javascript:void(0)" class="btn btn-primary" id="apply_discount" onclick="applyDiscount()">Apply</a><a href="javascript:void(0)" class="btn btn-primary" style="display:none" id="remove_button" onclick="remove_Discount()">Remove</a></td>';
              }
              else{
                 payment_table_data+= '<td class="cart_items"></td>';

              }
              payment_table_data+='</tr>';
                ...
                full_total_price=full_total_price.toFixed(2);
                 ...
                 $("#total_discount_price").val(total_discount_price);
                 $("#total_discounted_price").val(0);
              ...
              // $("#payment_table_data").remove();
              // $("#discount_items").html("");



               $("#discount_items").html(payment_table_data);
               $("#payment_table_data").load();
      ...
      $.ajax({
              ...
              success: function (response) {
               ...
               $("#membership_discount").val(membership_type);
                ...
                for(var p=0; p<items.length; p++){
                  ...
                  item_list+='<tr id="item_'+items[p]['id']+'"><td class="cart_items"><input type="hidden" id="itemCode_'+items[p]['id']+'" value="'+items[p]['itemCode']+'"><input type="hidden" id="itemQTY_'+items[p]['id']+'" value="'+items[p]['quantity']+'">'+k+'</td><td class="cart_items code_item ">'+items[p]['itemCode']+'</td>'+info1+'<td class="cart_items">'+items[p]['quantity']+'</td><td class="cart_items">'+items[p]['unit_price']+'</td><td class="cart_items">'+items[p]['subtotal']+'</td><td class="cart_items"><a href="javascript:void(0)" onclick="edit_itemInvoice('+items[p]['id']+')">Edit</a> <a href="javascript:void(0)" onclick="deleteItemInvoice('+items[p]['id']+')">Delete</a></td></tr>';
          ...
          for(var p=0; p<items.length; p++){
            ...
            sub_ammount=sgst_ammount+cgst_ammount+full_total_price;
             ...
             var info2='<td class="cart_items">'+items[p]['info1']+'</td>';
                  if(discountType==1 && membership_type>0)
                  {
                    info2='<td class="cart_items">'+items[p]['info1']+'<span class="applied_discount">*</span></h4></td>';
                  }

            // full_total_price=full_total_price+items[p]['unit_price'];
            item_list+='<tr id="item_'+items[p]['id']+'"><td class="cart_items"><input type="hidden" id="itemCode_'+items[p]['id']+'" value="'+items[p]['itemCode']+'"><input type="hidden" id="itemQTY_'+items[p]['id']+'" value="'+items[p]['quantity']+'">'+k+'</td><td class="cart_items">'+items[p]['itemCode']+'</td>'+info2+'<td class="cart_items">'+items[p]['quantity']+'</td><td class="cart_items">'+items[p]['unit_price']+'</td><td class="cart_items">'+items[p]['subtotal']+'</td><td  class="cart_items"><a href="javascript:void(0)" onclick="deleteItemInvoice('+items[p]['id']+')">Delete</a></td></tr>';
                ...
                if(discountType==1 && membership_type>0)
                  {
                    ...
                    total_discount_price=total_discount_price1.toFixed(2);
                    // alert(discount_applied[]);
                   payment_table_data+='<tr id="item_discount_'+items[p]['id']+'"><td class="cart_items"><input type="hidden" id="itemCode_'+items[p]['id']+'" value="'+items[p]['itemCode']+'"><input type="hidden" id="itemQTY_'+items[p]['id']+'" value="'+items[p]['quantity']+'">'+k+'</td><td class="cart_items">'+items[p]['itemCode']+'</td><td class="cart_items">'+items[p]['info1']+'</td><td class="cart_items">'+items[p]['subtotal']+'</td><td class="cart_items">'+discount_applied+'</td><td class="cart_items"><a href="javascript:void(0)" onclick="removeDiscount_item('+items[p]['id']+','+discount_applied+')">x</a></td></tr>';
              ...
              payment_table_data+='<tr id="item_total"><td class="cart_items"><input type="hidden" id="total_discounted_item_price" value="0">Total</td><td class="cart_items"></td><td class="cart_items"></td><td class="cart_items">'+total_item_price+'</td><td class="cart_items">'+total_discount_price+'</td>';
                if(total_discount_price>0){
            ...
            $("#subtotal_val").val(sub_ammount);
                ...
                $("#sub_total").val(full_total_price);
                 ...
                 $("#total_discount_price").val(total_discount_price);
                 $("#total_discounted_price").val(total_discount_price);
    ...
    function Dashboard_data_Report()
    {
           $.ajax({
            type: 'POST',
    ...
    function removeDiscount_item(id)
    {
       ...
       swal({title: "Are you sure?",
            ...
            function(isConfirm) {
                  if (isConfirm) {
                     ...
                     $("#item_discount_"+id).remove();

                     var total_discount = 0;
                  
                  var discount_item=$("#discount_items");

                    $(discount_item).find('input.discount').each(function() {
                      var values=  $(this).val();
                      total_discount = Number(total_discount)+Number(values);
                      total_discount=total_discount.toFixed(2);
                    
                    })
                    $("#Discount_total").text(total_discount);
                    $("#total_discount_price").val(total_discount);
    ...
    function applyDiscount()
    {
      ...
      var membership_discount_applied=$("#total_discount_price").val();
      $("#total_discounted_price").val(membership_discount_applied);
      finalammount();
      $("#remove_button").show();
      $("#apply_discount").hide();
    ...
    function remove_Discount()
    {
      ...
      $("#apply_discount").show();
       $("#remove_button").hide();
      var remove_discount= 0;
      $("#total_discounted_price").val(remove_discount);
       finalammount();
    }
