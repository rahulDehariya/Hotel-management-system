      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Membership</a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card ">
             ...
             <table style="border: 1px solid #ddd;padding: 15px;" id="cart_list_items" class="table">
                                                      
                 <thead>
                   <tr>
                      <th class="product-info">SN.</th>
                      <th class="product-info">Name</th>
                      <th class="product-quantity">Mobile</th>
                      <th class="product-price">Email</th>
                      <th class="product-price">Membership Number</th>
                      <th class="product-price">Membership Type</th>
         ...
         <div class="row">
              ...
              <div class="modal fade" id="editMember_model" role="dialog">
                  <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                          <h4 class="modal-title" style="width: 100%; text-align: center;">Edit Member
                          </h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                      </div>
                      <div class="modal-body">
