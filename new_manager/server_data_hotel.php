...
class Category extends Dbconfig
{
   public function __construct() {
    ...
    {
      global $con;
      $sql="UPDATE `invoice_items` SET status=3 where id='$id'";
    ...
    {
      global $con;
      $sql="UPDATE `invoice_items` SET status=4 where id='$id'";
    ...
    function getstaff($accNum,$POST)
    {
      ...
      $sql="SELECT  id,`name`, `mobile`, `email`, `jobType`, `jobTitle`, `JobStatus` FROM `Staff` WHERE accNum=$accNum and type=4 order by id desc";
      $result=mysqli_query($con,$sql);
...
// print_r($POST);die;
    ...
    $new_staffNum = $staffNum+1;
      ...
      $sql = "INSERT INTO `Staff`(`accNum`, `staffNum`, `name`, `code`, `dob`, `mobile`, `email`, `jobType`, `gender`, `origin`, `jobTitle`, `allocationHours`, `JobStatus`, `type`, `status`, `Req_tags`, `img`, `droptimezone`, `Grouping`, `activeState`) VALUES ('$accNum','$new_staffNum','$username','','$dob','$mobile','$email','$job_type','','','$memberNum','','','4','0','0','0','0','0','0')"; 
  ...
  {
       global $con;
       $sql="SELECT `id`,  `staffNum`, `name`, `code`, `dob`, `mobile`, `email`, `jobType`,  `origin`, `jobTitle`, `allocationHours`, `JobStatus`, `type`, `status` FROM `Staff` WHERE accNum=$accNum and id=$user_id ";
  ...
  public function insertConfirmedItem($accNum,$POST)
  {
    ...
    function InsertOrderPayment($POST)
    {
      ...
      if($pay_discount > 0)
      {
        ...
        $sql2 = "INSERT INTO `invoice_items`(`acNum`, `invoiceNum`, `invoiceId`, `product`, `item_id`, `qty`, `unit_price`, `unit_gst`, `percentage`, `subtotal`, `stock_id`, `staffNum`, `status`, `createdAt`, `updated_at`, `jobNumber`) VALUES ('$accNum','$invoiceNum','$invoice_id','0','0','1','-".$pay_discount."','0','0','-".$pay_discount."','0','0','4','$created_at','$created_at','$newjob')";
    ...
    function CreateNewTable($accNum,$POST){
      ...
      $quoteNumber = $quoteNumber+1;
        ...
        $sql = "INSERT INTO `invoices`(`acNum`, `invoiceNum`, `jobNumber`, `quoteNum`, `rcNum`, `info1`, `bookNum`, `comNum`, `invoiceSch`, `from_date`, `to_date`, `dueIn`, `clientNum`, `invType`, `bookingId`, `date_created`, `date_updated`, `status`,`pax`) VALUES ('$accNum','0','0','$quoteNumber','$department_id','$table','1','1','0','$created_at','$created_at','0','1','1','0','$created_at','$created_at','1','$pax')";
