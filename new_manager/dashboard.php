...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header modal-header-lg">
            <h4 class="modal-title" style="width: 100%;">New Order

            	<p class="col-md-4" style="float: right;"><!-- <span>T-</span> -->
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4 pr-1">
                  <div class="form-group">
                    <label>Pax</label>
                    <input type="text" id="paxNumber" Name="paxNumber" class="form-control" placeholder="Pax" value="">
                  </div>
                </div>
                <!-- <div class="col-md-4 pl-1">
                  <div class="form-group">
            ...
            <div class="add_new_item_div" style="padding: 15px;border: 1px solid #ddd;margin: 0 0 10px 0px;">
                ...
                <div class="col-md-2 px-1">
                  <div class="form-group">
                    ...
                    <input list="browsers" name="item_quantity" id="item_quantity" placeholder="Quantity" style="width: 100%;margin-top: 5px;">
