<?php
   ...
   // $myCategory = new Category();
    ...
    $data_Cat_json=file_get_contents(HTTP_HOST."ajax_autopart.php?action=orderSuccessfull&order_id=".$order_id);
    $data_Cat=json_decode($data_Cat_json,true);

    // print_r($data_Cat);
    // $data_Cat = $myCategory->emailToClientOnOrderSubmit(accNum,$_GET['order_id']); 
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
        ...
        <div class="header-middle hidden-compact section">
            <div class="container">
                <div class="row">           
         ...
         <div class="header-bottom hidden-compact section">
         <div class="container">
         <div class="row">
                ...
                <div class="products-category">
                   <div class="page-width" data-section-id="cart-template" data-section-type="cart-template">
                      ...
                      <!-- <div class="section-header text-center">
                        ...
                        <h2 style="text-align: center; color: black;">Order has been successfully submitted. We will contact you soon...</h2>
