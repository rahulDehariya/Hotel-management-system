	    ...
	    $.ajax({
	            ...
	            // $("#job_items_list").html("");
                  ...
                  if(obj[p]['status']!=3){
                    ...
                    job_items +='<button onclick=Get_item_prepared('+obj[p]['id']+')  id="item_prepared" class="btn btn-primary btn-round" style="margin-left: 100px;margin-bottom: 5px;">Prepared</button>';
