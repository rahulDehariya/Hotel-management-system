...
if(isset($_SESSION['is_logged_in']) && $_SESSION['is_logged_in'] == 1)
{
  ...
  }elseif(in_array("order", $authority)){

    echo "<script>window.location.href='order_dashboard.php';</script>";exit;
    //header("location:order_dashboard.php");
  }elseif(in_array("kitchen", $authority)){

    //header("location:kitchen2.php");
    echo "<script>window.location.href='kitchen2.php';</script>";exit;
  }
}
          ...
          if(err_flag == 0){
             ...
             $.ajax({
              ...
              if(response == 1){
                ...
                // window.location.reload();
                window.location="order_dashboard.php  ";
              }else if(response == 3){
                // window.location.reload();
                window.location="kitchen2.php  ";
              }else{
                $("#login_failed").show();
              }
            }
