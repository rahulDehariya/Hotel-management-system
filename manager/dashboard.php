          ...
          <div class="item_table payment_div_table" id="payment_table" style="display: none">
              ...
              <div class="col-md-8">
                  <br> 
                   ...
                   <input  name="total_discounted_item_price"  id="total_discounted_price"  type="hidden" value="" />
    ...
    function GetIvoiceDetail(invoiceId){
    	$.ajax({
            ...
            success: function (response) {
            	...
            	for(var p=0; p<items.length; p++){
                 ...
                 var info1='<td class="cart_items">'+items[p]['info1']+'</td>';
                  if(discountType==1 && membership_type>0)
                  {
            		...
            		item_list+='<tr id="item_'+items[p]['id']+'"><td class="cart_items"><input type="hidden" id="itemCode_'+items[p]['id']+'" value="'+items[p]['itemCode']+'"><input type="hidden" id="itemQTY_'+items[p]['id']+'" value="'+items[p]['quantity']+'">'+k+'</td><td class="cart_items">'+items[p]['itemCode']+'</td>'+info1+'<td class="cart_items">'+items[p]['quantity']+'</td><td class="cart_items">'+items[p]['unit_price']+'</td><td class="cart_items">'+items[p]['subtotal']+'</td></tr>';
                ...
                if(discountType==1 && membership_type>0)
                  {
                    ...
                    total_item_price=Number(total_item_price)+Number(price_item);
                   ...
                   payment_table_data+='<tr id="item_'+items[p]['id']+'"><td class="cart_items"><input type="hidden" id="itemCode_'+items[p]['id']+'" value="'+items[p]['itemCode']+'"><input type="hidden" id="itemQTY_'+items[p]['id']+'" value="'+items[p]['quantity']+'">'+k+'</td><td class="cart_items">'+items[p]['itemCode']+'</td><td class="cart_items">'+items[p]['info1']+'</td><td class="cart_items">'+items[p]['subtotal']+'</td><td class="cart_items">'+discount_applied+'</td><td class="cart_items"><a href="javascript:void(0)" onclick="removeDiscount_item('+items[p]['id']+')">x</a></td></tr>';
              ...
              payment_table_data+='<tr id="item_total"><td class="cart_items"><input type="hidden" id="total_discounted_item_price" value="'+total_discount_price+'">Total</td><td class="cart_items"></td><td class="cart_items"></td><td class="cart_items">'+total_item_price+'</td><td class="cart_items">'+total_discount_price+'</td><td class="cart_items"></td></tr>';
