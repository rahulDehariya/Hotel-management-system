...
$res = file_get_contents($HTTP_HOST."ajax.php?action=getMainCategories&menuNum=".$menuCategoryId);
...
if(isset($main_Cat[0]['categoryNum'])){
    ...
    $res = file_get_contents($HTTP_HOST."ajax.php?action=getMainCategories&menuNum=".$first_category);
