       ...
       <div class="header-middle hidden-compact" >
            ...
            <div class="container" >
                ...
                <div class="row" style="margin-top: 15px;">
                  ...
                  <div class="col-lg-6" style="background-color: rgba(137, 133, 133, 0.42);color: #ccc;border-radius: 15px;padding: 10px; text-align: center;">Priemium Quality At Affordable Prices</div>
                  <div class="col-lg-3"></div>
                </div>
