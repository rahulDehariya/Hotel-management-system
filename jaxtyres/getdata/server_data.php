...
function GetSpData($accNum,$POST){
  ...
  function getSpecification($accNum,$menu_id)
  {
    global $con;

    $sql="SELECT   `sp1`, `sp2`, `sp3`, `sp4`, `sp5`, `sp6` FROM `ecom_item_special` WHERE accNum='$accNum' and   itemNum='$menu_id'";
    $result=mysqli_query($con,$sql);
...
function GetSp2($accNum,$POST){
  ...
  $sql="SELECT DISTINCT(sp2) from ecom_item_special where sp1='$sp1' and accNum = ".$accNum;
  // echo $sql;die;
