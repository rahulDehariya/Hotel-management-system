<?php
   ...
   $data_Cat_json=file_get_contents($HTTP_HOST."ajax.php?action=getCategoriesTree");
   ...
   $product_data_json=file_get_contents($HTTP_HOST."ajax.php?action=getMenuItems&categoryNum=".$cat_id);
   ...
   // print_r($product_data); die;
    ...
    $getCartItems_json=file_get_contents($HTTP_HOST."ajax.php?action=getCartItemsofuser&user_id=$user_id&guest_id=$guest_id&is_guest=$is_guest");
    ...
    if(isset($_SESSION['user_id'])){
        ...
        $getUserDetails_json=file_get_contents($HTTP_HOST."ajax.php?action=getUserDetails&user_id=".$user_id);
        $getUserDetails=json_decode($getUserDetails_json,true);

        $getUserAddress_json=file_get_contents($HTTP_HOST."ajax.php?action=getUserAddress&user_id=".$user_id);
          ...
          success: function (response) {
            ...
            if(payment_type == "CC"){
             // swal("Good job!", "Proceed Payment", "success");
              ...
              window.location.href = "https://autohubsolutions.com.au/Pay/P/checkout.php?order_id="+obj_data['order_id']+"&invoice_id="+obj_data['invoice_id']+"&total="+obj_data['total_price']+"&email="+obj_data['email']+"&name="+obj_data['name']+"&address="+obj_data['address']+"&paymenttype=card&accNum="+accNum;
                   ...
                   <div class="page-width" data-section-id="cart-template" data-section-type="cart-template">
                    ...
                    <table style="border: 1px solid #ddd;" id="cart_list_items" class="form-group">
                      ...
                      <?php } ?>
                        ...
                        <div class="col-md-6 form-group" style="padding-right: 0;padding-left: 0;">
                          <div class="col-md-12">
